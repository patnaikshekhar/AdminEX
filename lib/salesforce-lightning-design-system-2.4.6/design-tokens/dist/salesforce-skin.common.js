module.exports = {
  ...
  colorBorderReminder: "rgb(168, 183, 199)",
  // Our product brand blue.
  ...
  colorBackground: "rgb(250, 250, 249)",
  ...
  shadowReminder: "0 2px 0 0 rgba(0, 0, 0, 0.1)",
  // Shadow for header.
  ...
  brandBandUserDefaultImage: "",
  brandBandGroupPrivateDefaultImage: "",
  brandBandGroupPublicDefaultImage: "",
  brandBandGroupUnlistedDefaultImage: "",
  brandBandUserDefaultImageMedium: "",
  brandBandGroupPrivateDefaultImageMedium: "",
  brandBandGroupPublicDefaultImageMedium: "",
  brandBandGroupUnlistedDefaultImageMedium: "",
  brandBandUserDefaultImageSmall: "",
  brandBandGroupPrivateDefaultImageSmall: "",
  brandBandGroupPublicDefaultImageSmall: "",
  brandBandGroupUnlistedDefaultImageSmall: "",
  brandBandColorBackgroundPrimary: "rgb(253, 253, 253)",
  brandBandColorBackgroundSecondary: "rgb(253, 253, 253)",
  // These RGBA values need to be updated if BRAND_BAND_COLOR_BACKGROUND_PRIMARY changes, solves webkit bug
  brandBandColorBackgroundPrimaryTransparent: "rgba(253, 253, 253, 0)",
  // These RGBA values need to be updated if BRAND_BAND_COLOR_BACKGROUND_SECONDARY changes, solves webkit bug
  ...
  pageHeaderShadow: "0 2px 0 0 rgba(0, 0, 0, 0.10)",
  // Hard dropshadow found on outer cards
  cardShadow: "0 2px 0 0 rgba(0, 0, 0, 0.10)",
